(function () {
    ...
    function renderIcd(payload) {
        ...
        if (available && payload.ied_name && payload.runtime_ied_name && payload.ied_name !== payload.runtime_ied_name) { ied += "（与运行配置不一致）"; }
        setText("icd-ied-name", ied); setText("icd-runtime-ied-name", payload.runtime_ied_name || "--");
